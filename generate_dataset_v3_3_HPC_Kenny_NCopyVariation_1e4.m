...
function generate_dataset_v3_3_HPC_Kenny_NCopyVariation_1e4(run)

    rng(run)

    %% Reaction
    %num_of_mol_array = 1e3;
    num_of_mol = 1e4; % # of initial molecules
    ...
    clusterx=clusters.centre_x;
    save(sprintf('ClusterX_Run%d.txt',run),'clusterx','-ASCII','-append')
